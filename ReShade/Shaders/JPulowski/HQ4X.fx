...
float4 PS_HQ4X(float4 pos : SV_Position, float2 uv : TEXCOORD) : SV_Target
{
	...
	const float max_w = HQ4XMaxFilterWeigth; // max filter weight
	const float min_w = HQ4XMinFilterWeigth; // min filter weight
...
technique HQ4X_Tech < enabled = RESHADE_START_ENABLED; toggle = HQ4X_ToggleKey; >
{
	pass
	{
